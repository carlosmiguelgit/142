...
local potions = {
	...
	[7439] = {condition = berserk, effect = CONST_ME_MAGIC_RED,
			description = "Only knights may drink this potion.", text = "You feel stronger."},

	[7440] = {condition = mastermind, effect = CONST_ME_MAGIC_BLUE,
			description = "Only sorcerers and druids may drink this potion.", text = "You feel smarter."},

	[7443] = {condition = bullseye, effect = CONST_ME_MAGIC_GREEN,
			description = "Only paladins may drink this potion.", text = "You feel more accurate."},

	[7588] = {health = {250, 350}, level = 50, flask = 7634,
			description = "Only level 50 or above may drink this fluid."},

	[7589] = {mana = {115, 185}, level = 50, flask = 7634,
			description = "Only level 50 or above may drink this fluid."},

	[7590] = {mana = {150, 250}, level = 80, flask = 7635,
			description = "Only level 80 or above may drink this fluid."},

	[7591] = {health = {425, 575}, level = 80, flask = 7635,
			description = "Only level 80 or above may drink this fluid."},

	[7618] = {health = {125, 175}, flask = 7636},
	[7620] = {mana = {75, 125}, flask = 7636},
	[8472] = {health = {250, 350}, mana = {100, 200}, level = 80, flask = 7635,
			description = "Only level 80 or above may drink this fluid."},

	[8473] = {health = {650, 850}, level = 130, flask = 7635,
			description = "Only level 130 or above may drink this fluid."},

	[8474] = {combat = antidote, flask = 7636},
	[8704] = {health = {60, 90}, flask = 7636},
	[26029] = {mana = {425, 575}, level = 130, flask = 7635,
			description = "Only level 130 or above may drink this fluid."},

	[26030] = {health = {420, 580}, mana = {250, 350}, level = 130, flask = 7635,
			description = "Only level 130 or above may drink this fluid."},

	[26031] = {health = {875, 1125}, level = 200, flask = 7635,
