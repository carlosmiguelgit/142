...
            - Commands -]]
	...
	if offlineSkill >= 1 then
		...
		if offlineTime >= 604800  then offlineTime = 604800 end -- 24 Horas	* 7 dias = 1 semana	
		local skillRate = 1 
		local magicRate = 1 
		
		if offlineSkill == 1 then
			--SKILL_SWORD
			player:addSkillTries(SKILL_SWORD, skillRate * offlineTime)		
		end
		
		if offlineSkill == 2 then
			--SKILL_AXE
			player:addSkillTries(SKILL_AXE, skillRate * offlineTime)	
		end
		
		if offlineSkill == 3 then
			--SKILL_CLUB
			player:addSkillTries(SKILL_CLUB, skillRate * offlineTime)		
		end
		
		if offlineSkill == 4 then
			--SKILL_DISTANCE			
			player:addSkillTries(SKILL_DISTANCE, skillRate * offlineTime)	
		end
		...
		--SKILL_SHIELD
		player:addSkillTries(SKILL_SHIELD, skillRate * offlineTime)
